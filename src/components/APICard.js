...
function APICard({ api }) {
  return (
    <section className="w-full md:w-2/3 lg:w-1/3 xl:w-1/4 px-2 mb-4 md:mx-2 p-4 bg-gray-800 text-white rounded-md hover:bg-gray-700 border border-gray-700 transition-colors duration-300 p-6 flex flex-col lg:h-56" role="listitem">
